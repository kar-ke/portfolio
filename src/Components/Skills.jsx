  ...
  return (
    <div name="Skills" className=' mobile:mt-16  desktop:mt-24 laptop:mt-14'>
        ...
        <div className='flex mobile:flex-col tablet:flex-row justify-center mobile:gap-8 tablet:gap-0 mt-16 laptop:mt-16 '>
            ...
            <div className='outline outline-offset-2 outline-1 outline-black-500 rounded-lg mx-4 tablet:h-[22.5rem] tablet:w-[25rem] laptop:w-[25rem]'>
                    <h1 className='flex text-xl text-[#1D1D1D] font-semibold justify-center top-0 my-6'>Frontend development</h1>
                <ul className='flex flex-wrap justify-center py-8 items-center gap-8'>
                    {links.map(({link})=> (
            ...
            <div className='justify-center items-center outline outline-offset-2 outline-1 outline-black-500 rounded-lg mx-4 tablet:h-[22.5rem] tablet:w-[25rem] laptop:w-[25rem]'>
                <h1 className='flex text-xl text-[#1D1D1D] justify-center font-semibold my-6'>Supporting tools</h1>
                <ul className='flex flex-wrap justify-center items-center py-8 gap-8  '>
                    {links2.map(({link})=> (
                        <li className='flex align-baseline my-4'>
                            <img className='h-5 mx-2' src={verifiedlogo} alt='verifylogo'></img>
                            <p className='text-2 font-semibold text-[#454545]'>{link}</p>
