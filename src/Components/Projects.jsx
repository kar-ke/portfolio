...
const Projects = () => {
  return (
    <div name="projects" className='mobile:mt-16 laptop:mx-24 desktop:mx-44  desktop:mt-24 laptop:mt-14'>
        ...
        <div className='flex flex-col tablet:flex-row  justify-center mobile:gap-8 tablet:gap-0 mt-16'>
            <div className='flex flex-col outline outline-1 outline-gray-400 rounded-3xl mx-6 py-4'>
                <img src={proj1} alt='project-1-img' className=' rounded-3xl mx-8 my-8 '></img>
                <div className='flex justify-center align-baseline pb-4'>
                    <img src={gitLogo} className='h-12 px-6'></img>
                    <button className='text-xl outline  outline-gray-400 outline-1  py-3 px-8 rounded-full font-semibold text-[#1D1D1D] hover:text-[20pxc] duration-200'>demo</button>
                </div>
            </div>
